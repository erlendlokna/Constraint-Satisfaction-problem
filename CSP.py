...
class CSP:
    ...
    def backtrack(self, assignment):
        ...
        for value in assignment[var]:
            ...
            # Run inference to update the new_assignment based on constraints
...
if __name__ == "__main__":
    #Easy sudoku
    Sudoku("sudoku/easy.txt").solve()
    
    #medium sudoku
    Sudoku("sudoku/medium.txt").solve()

    #hard sudoku
    Sudoku("sudoku/hard.txt").solve()

    #very hard sudoku
    Sudoku("sudoku/veryhard.txt").solve()
